...
class AboutIteration(Koan):
    ...
    def test_map_transforms_elements_of_a_list(self):
        ...
        mapping = map(self.add_ten, seq) # returns a type of iterator
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Applies the argument function to item of the iterable, carrying through the result from the previous item
        # Analogous to reduce (or maybe its called summarize) in Javascript.
        # It reduces an iterable down to a single value. So, unlike map and filter,
